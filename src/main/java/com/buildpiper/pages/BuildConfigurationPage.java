...
//		ui_IsElementDisplay(ui_waitForElementToDisplay(repoDetails, Pause.MEDIUM));
	...
	@FindBy(xpath = "//input[@name='custom_parameters']")
	WebElement customParameters;
	public BuildConfigurationPage CreateAndValidateBuildConfig_withExtraParameters(String gitURL,String BranchName,String FilePath,String DockerFilePath,ArrayList<String> ChipType,ArrayList<String> LanguageName,String preHookPass,String EnvName) {
...
//        	}
//        }
		//---------------- Enter values in Custom Parameters------ 
		ui_setvalue(customParameters, "custom Parameters", "~!`3#$%^&&*( yt 12345+_-:;[a-z]{}");
		ui_wait(2);
		Assert.assertEquals(customParameters.getAttribute("value"), "~!`3#$%^&&*( yt 12345+_-:;[a-z]{}");
		ui_clearAndSetValue(customParameters,  "QA Test");
		ui_wait(3);
		ui_click(clickContinueBtn, "Poc_QA clickContinueBtn");
		ui_wait(5);
...
//		ui_wait(10);
	...
	public BuildConfigurationPage CreateAndValidateBuildConfig_MultiplePrehook(String gitURL,String BranchName,String FilePath,String DockerFilePath,ArrayList<String> ChipType,ArrayList<String> LanguageName,String preHookPass1,String preHookPass2,String preHookPass3,String preHookPass4,String preHookPass5,String EnvName) {
...
//		ui_click(clickContinueBtn, "Poc_QA clickContinueBtn");
		...
		//ui_IsElementDisplay(ui_waitForElementToDisplay(hooksSubHeading2, Pause.MEDIUM));
		ui_click(preHooksSwitch, "Poc_QA preHooksSwitch");
		ui_setvalue(preHooksPasswordBox, "Poc_QA preHooksPasswordBox1", preHookPass1);
		ui_wait(2);
		ui_click(addNewPreHook, "clicks on add New Hook");
		ui_setvalue(preHooksPasswordBox, "Poc_QA preHooksPasswordBox2", preHookPass2);
		ui_wait(2);
		ui_click(addNewPreHook, "clicks on add New Hook");
		ui_setvalue(preHooksPasswordBox, "Poc_QA preHooksPasswordBox2", preHookPass3);
		ui_wait(2);
		ui_click(addNewPreHook, "clicks on add New Hook");
		ui_setvalue(preHooksPasswordBox, "Poc_QA preHooksPasswordBox2", preHookPass4);
		ui_wait(2);
		ui_click(addNewPreHook, "clicks on add New Hook");
		ui_setvalue(preHooksPasswordBox, "Poc_QA preHooksPasswordBox2", preHookPass5);
		ui_wait(2);		
		ui_click(submitHooks, "Poc_QA submitHooks");
