...
//----------------------Common Locators-------------
	...
	@FindBy(xpath = "//span[contains(@class,'MuiButtonBase-root MuiIconButton-root')]/following-sibling::span[1]")
	...
	public JobExecutionActivity ActivityFilterby_Users() {
		...
		Assert.assertEquals(activityUserList.size()>0, true);
		ui_click(clearSelectionButton, "clearSelectionButton");
	return this;
	}
